...
We are currently working on a draft research paper that is based on the findings and results obtained during this research grant. The paper is planned to be submitted to the International Conference on Applied Cryptography and Network Security [[18]](/docs/research/references) in Kyoto, Japan on June 19-22, 2023. The research paper is organized into five main chapters.
